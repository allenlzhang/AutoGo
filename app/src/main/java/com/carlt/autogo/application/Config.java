...
public class Config {
    ...
    public static String apiKey          = "38EeSjf7EI7io5V4DwwoEdX6";//替换为你的apiKey(ak);
    public static String secretKey       = "2oiwj2UtWf3If3hIQEdZsIx0GqjBvRvh";//替换为你的secretKey(sk);
   ...
   // public static String licenseFileName = "idl.face-android";
    public static String licenseID       = "AutoGo-Face-Login-face-android";
